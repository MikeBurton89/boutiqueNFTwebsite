...
function App() {
  ...
  const openSeaLogo = <svg width="100" height="100" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg" >
      ...
      <main className='h-full grid grid-cols-1 grid-rows-6 md:grid-cols-4 md:grid-rows-6'>
        ...
        <section id='slideshow' className='col-span-1 row-span-2 md:col-span-4 md:row-span-2 bg-background-main border-t border-text_dark' >
          <Marquee speed={20} gradient={false}>
            <div>
              <img src={balenciagaSneakersWh} alt='Balenciaga Shoe' title='Balenciaga White Sneaker' className='md:w-1/4 md:h-1/4 w-1/5 h-1/5' />
            </div>
            <div>
              <img src={balenciagaSneakers} alt='Balenciaga Shoe' title='Balenciaga Sneaker' className='md:w-1/4 md:h-1/4 w-1/5 h-1/5' />
            </div>
            <div>
              <img src={designerBag} alt='Designer Bag' title='Designer Bag' className='md:w-1/4 md:h-1/4 w-1/5 h-1/5' />
            </div>
            <div>
              <img src={designerSneaker} alt='Designer Sneaker' title='Designer Sneaker' className='md:w-1/4 md:h-1/4 w-1/5 h-1/5' />
            </div>
          </Marquee>
        </section>
      </main >
